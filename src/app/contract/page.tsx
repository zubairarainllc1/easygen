...
export default function ContractTemplatePage() {
  ...
  const handleNext = () => {
    ...
    router.push(`/contract/editor?${params.toString()}`);
  };
      ...
      <header className="sticky top-0 z-50 w-full bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
       ...
       <div className="container mx-auto p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col items-center text-center space-y-4 mb-12">
            <h1 className="text-3xl md:text-4xl font-bold tracking-tight font-sans">Choose Your Contract Style</h1>
            <p className="text-base md:text-lg text-muted-foreground max-w-2xl">
                Select a style and color scheme to create a professional contract that matches your brand.
            </p>
        </div>

        <div className="mb-12">
            <h2 className="text-2xl font-semibold text-center mb-6 font-sans">1. Select a Style</h2>
        ...
        <div className="mb-12">
            ...
            <div className="flex justify-center items-center gap-4">
             ...
             <p className="text-center text-muted-foreground mt-2">{withCompanyLogo ? "Contract will include a company logo." : "Contract will not include a company logo."}</p>
        </div>
