...
export default function QuotationTemplatePage() {
  ...
  const handleNext = () => {
    ...
    router.push(`/quotation/editor?${params.toString()}`);
  };
      ...
      <header className="sticky top-0 z-50 w-full bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
       ...
       <div className="container mx-auto p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col items-center text-center space-y-4 mb-12">
            <h1 className="text-3xl md:text-4xl font-bold tracking-tight font-sans">Choose Your Quotation Style</h1>
            <p className="text-base md:text-lg text-muted-foreground max-w-2xl">
                Select a template and color scheme to create a professional quotation for your clients.
            </p>
        </div>
        ...
        <div className="mb-12">
            ...
            <div className="flex justify-center items-center gap-4">
             ...
             <p className="text-center text-muted-foreground mt-2">{withCompanyLogo ? "Quotation will include a company logo." : "Quotation will not include a company logo."}</p>
        </div>
