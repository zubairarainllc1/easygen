...
export default function FullScreenInvoicePreview() {
  ...
  if (!previewData) {
    return <div className="flex items-center justify-center h-screen text-red-500 text-center p-4">Failed to load invoice preview data. Please go back and try again.</div>;
  }
